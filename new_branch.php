	...
	<div class="card card-outline card-danger">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Address</Address></label>
            ...
            <div class="row">
              <div class="col-sm-6 form-group d-none ">
               ...
               <textarea name="country" id="" cols="30" rows="2" value="" class="form-control d-none"><?php echo isset($country) ? $country : '' ?></textarea>
</div>
              <div class="col-sm-6 form-group ">
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  bg-gradient-red mx-2" form="manage-branch">Save</button>
