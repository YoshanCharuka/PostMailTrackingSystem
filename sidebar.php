      ...
      <nav class="mt-2">
        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_parcel" class="nav-link nav-new_parcel tree-item" target="_blank">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
              ...
              <?php  /*array("Item Accepted<br/>by Courier","Collected","Shipped","In-Transit","Arrived At<br/>Destination","Out for Delivery","Ready to Pickup","Delivered","Picked-up","Unsuccessfull<br/>Delivery Attempt"); */
             /* $status_arr = array("Item Accepted to Post Office","Posted","In-Transit","Arrived At Postoffice","Out for Poster","Delivered","Return to Sender","Unsuccessfull Delivery Attempt");
