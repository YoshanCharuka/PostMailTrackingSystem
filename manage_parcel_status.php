...
<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			...
			<?php $status_arr = array("Item Accepted to Post Office","Posted","In-Transit","Arrived At Postoffice","Out for Poster","Delivered","Return to Sender","Unsuccessfull Delivery Attempt"); ?>
