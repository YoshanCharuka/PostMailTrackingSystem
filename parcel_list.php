	...
	<div class="card card-outline card-yellow">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-yellow " href="form.php" target="_blank"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
						...
						<td class="text-center">
							...
							switch ($row['status']) {
								case '1':
									...
									break;
								case '2':
									echo "<span class='badge badge-pill badge-info'> Posted</span>";
									break;
								case '3':
									echo "<span class='badge badge-pill badge-primary'> In-Transit</span>";
									break;
								case '4':
									echo "<span class='badge badge-pill badge-primary'> Arrived At Destination Postoffice</span>";
									break;
								case '5':
									echo "<span class='badge badge-pill badge-primary'> Out for Poster</span>";
									break;
								case '6':
								...
								case '7':
									...
									break;
								case '8':
									echo "<span class='badge badge-pill badge-success'> Returned to Sender</span>";
									break;
								case '9':
								...
								default:
									echo "<span class='badge badge-pill badge-info'> Item Accepted by Post office</span>";
